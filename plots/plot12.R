...
plot12 <- df_special_v2  %>% filter(Cast_Seq==1) %>%
  ...
  facet_grid(f_logNote3~ Raid_Color,scales="free_y") +
  vivax_theme()+
...
ggsave(paste0("./_img/plot_12.png"),plot12,
       width = 5, height =11,units="in",device = "png",dpi=300)
